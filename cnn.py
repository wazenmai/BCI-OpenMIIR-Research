...
def cnnmodel():
    clear_session()
    model=Sequential()
    model.add(Conv1D(filters=32,kernel_size=3,strides=1,input_shape=(3073,64)))#1
    ...
    # model.add(Dense(12,activation='relu'))#11
    # model.add(Dense(1, activation='softmax'))#12
...
if __name__ == '__main__':
    ...
    for subject in subjects:
        ...
        data, label, group = generate_data_and_label(raw, event, condition=args.cond, psd=args.psd)
